...
import { Survey, DisplaySurveyType, SurveyPosition, PropertyMatchType, SurveyEventWithFilters, SurveyActionType, RemoteConfigResult as RemoteConfigResult$1, RemoteConfig, Compression, SessionRecordingRemoteConfig, Client, Disposable, KeyValueStore, Listener, CapturedEventInfo, DeepReadonly, SessionContext as SessionContext$1, Extension as Extension$1, CaptureOptions, SendRequestInit, ApiResponse } from '@posthog/browser-common';
