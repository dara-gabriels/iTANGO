...
export { EventType, IncrementalSource, MouseInteractions, Replayer, ReplayerEvents, addCustomEvent, canvasMutation, freezePage, getLastSnapshotCost, getMutationCost, mirror, record, resetMaxDepthState, resetSnapshotCostState, takeFullSnapshot, utils, wasMaxDepthReached };
export type { MutationCost, PlayerMachineState, ReplayPlugin, SnapshotCost, SpeedMachineState, eventWithTime, playerConfig, recordOptions };
