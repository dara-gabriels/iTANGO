...
function SurveyPopup(_a) {
    ...
    var surveyPopupDelayMilliseconds = ((_b = survey.appearance) === null || _b === void 0 ? void 0 : _b.surveyPopupDelaySeconds)
        ...
        : 0;
    var _w = usePopupVisibility(survey, posthog, surveyPopupDelayMilliseconds, isPreviewMode, removeSurveyFromFocus, isPopup, surveyContainerRef, skipShownEvent, surveyLanguage), isPopupVisible = _w.isPopupVisible, isSurveySent = _w.isSurveySent, hidePopupWithViewTransition = _w.hidePopupWithViewTransition;
    /**
